...
const { status, data } = await apiInstance.apiTodoIdDelete(
    id
);
```
...
const { status, data } = await apiInstance.apiTodoIdGet(
    id
);
```
...
const { status, data } = await apiInstance.apiTodoIdPut(
    id,
    todoItem
);
```
...
const { status, data } = await apiInstance.apiTodoPost(
    todoItem
);
```
