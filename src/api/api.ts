...
export const AppointmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAppointments: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AppointmentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAppointments(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AppointmentItem>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAppointments(options);
...
export const AppointmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAppointments(options?: RawAxiosRequestConfig): AxiosPromise<Array<AppointmentItem>> {
            return localVarFp.getAppointments(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AppointmentApi extends BaseAPI {
    ...
    public getAppointments(options?: RawAxiosRequestConfig) {
        return AppointmentApiFp(this.configuration).getAppointments(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PlantApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPlants(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Plant>>> {
...
export const WeatherApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiWeatherCurrentGet: async (city?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const WeatherApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiWeatherCurrentGet(city?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiWeatherCurrentGet(city, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeatherApi.apiWeatherCurrentGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const WeatherApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiWeatherCurrentGet(city?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.apiWeatherCurrentGet(city, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class WeatherApi extends BaseAPI {
    ...
    public apiWeatherCurrentGet(city?: string, options?: RawAxiosRequestConfig) {
        return WeatherApiFp(this.configuration).apiWeatherCurrentGet(city, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const WeatherForecastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getWeatherForecast(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WeatherForecastItem>>> {
...
export const WeatherForecastApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getWeatherForecast(options?: RawAxiosRequestConfig): AxiosPromise<Array<WeatherForecastItem>> {
